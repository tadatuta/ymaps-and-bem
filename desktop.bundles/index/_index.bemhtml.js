var BEMHTML = function() {
  var cache,
    ...
    function apply() {
        ...
        if (__t === "attrs") {
            ...
            if (__t === "menu") {
                if (this.elem === "item") {
                    return {
                        "data-group": this.ctx.placemarkId
                    };
                    return;
                } else {
                    if (!!this.elem === false) {
                        return {
                            "data-group": this.ctx.placemarksGroupId
                        };
                        return;
                    } else {
                        return $29.call(this);
    ...
    function $109() {
        if (!(this["__$anflg"] !== 971756377) === false) {
            if (!!this.elem === false) {
